namespace pruebaAppApi.Application._3.Common
{
    ...
    public static class Constant
    {
        ...
        public struct ResponseMessage
        {
            ...
            public const string SuccessGetMessage = "GET Request successful.";
            public const string SuccessDeleteMessage = "DELETE Request successful.";
            public const string SuccessUpdateMessage = "UPDATE Request successful.";
